...
class DetailBeratScreen extends StatefulWidget {
  const DetailBeratScreen({Key? key}) : super(key: key);
...
class _DetailBeratScreenState extends State<DetailBeratScreen> {
  ...
  void _onKeyPressed(String value) {
    setState(() {
      if (value == '↲') {
        ...
        // Append digit to weightInput
        if (weightInput == '0') {
          weightInput = value; // Replace initial 0 with the digit
        } else {
          weightInput += value;
        }
      }
  ...
  double get weight => double.tryParse(weightInput) ?? 0.0;
    ...
    return ElevatedButton(
      ...
      child: Text(
        ...
        style: const TextStyle(
          color: Colors.black, // Mengubah warna tulisan menjadi hitam
